...
public class ComprasController {
    ...
    private ArrayList<ItemColecao> compras = new ArrayList<ItemColecao>();
    ...
    private void mostrarCompras() {
        ...
        for (int i = 0; i< compras.size(); i++) {
            ...
            if (c.getImagem() != null && c.getImagem().isEmpty() == false) {

                Image imagem =
                        new Image("file:" + c.getImagem(), 100, 0, true, true);
            ...
            Label l1 = new Label("Nome: " + c.getNome());
            Label l2 = new Label("Ano: " + c.getAno());
            Label l3 = new Label("Pago: " + c.getPago());
            Label l4 = new Label("Estimado: " + c.getValorEstimado());
            Label l5 = new Label("Data: " + c.getDataCompra());
            Label l6 = new Label("Tipo: " + c.getTipo());

            info.getChildren().addAll(l1, l2, l3, l4, l5, l6);

            box.getChildren().addAll(img, info);

            vboxCompras.getChildren().add(box);
        }
    }
