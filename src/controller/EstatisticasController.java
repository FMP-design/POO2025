...
public class EstatisticasController {
    ...
    private Label criarLabel(String texto) {
        ...
        l.setStyle("-fx-font-family: Georgia; -fx-font-size: 16px; -fx-text-fill: #C8A2C8;");
        return l;
    }
    ...
    public void initialize() {
        ...
        for (int i = 0; i < ficheiros.length; i++) {
            ...
            try {
                ...
                for (int j = 0; j < lista.size(); j++) {
                    ...
                    try { vEst = Double.parseDouble(item.getValorEstimado()); }
                    catch (Exception e) {}

                    try { vPago = Double.parseDouble(item.getPago()); }
                    catch (Exception e) {}
        ...
        vboxStats.getChildren().add(criarLabel("Lucro / Prejuízo: " + lucro + " €"));
