...
public class VendasController {
    ...
    @FXML
    private VBox vboxVendas;

    private final String CAMINHO =
            "C:\\Users\\fm\\eclipse-workspace\\Collex\\fnFiles\\";

    private ArrayList<ItemColecao> vendas = new ArrayList<ItemColecao>();
    ...
    private void mostrarVendas() {
        ...
        vboxVendas.getChildren().clear();

        for (int i = 0; i < vendas.size(); i++) {

            ItemColecao v = vendas.get(i);
            ...
            Label l1 = new Label("Nome: " + v.getNome());
            Label l2 = new Label("Ano: " + v.getAno());
            Label l3 = new Label("Pago: " + v.getPago());
            Label l4 = new Label("Estimado: " + v.getValorEstimado());
            Label l5 = new Label("Data: " + v.getDataCompra());
            Label l6 = new Label("Tipo: " + v.getTipo());

            info.getChildren().addAll(l1, l2, l3, l4, l5, l6);

            box.getChildren().addAll(img, info);

            vboxVendas.getChildren().add(box);
        }
    }
